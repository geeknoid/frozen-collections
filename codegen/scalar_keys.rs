...
fn main() {
    ...
    let map = HashMap::new(input.clone(), PassthroughHasher::default());
    for key in probe.clone() {
...
#[inline(never)]
fn call_std_hash_map(map: &HashbrownMap<i32, i32, ahash::RandomState>, key: i32) -> bool {
    map.contains_key(&key)
}

#[inline(never)]
fn call_hash_map_with_passthrough_hasher(
    map: &HashMap<i32, i32, PassthroughHasher>,
    key: i32,
) -> bool {
    map.contains_key(&key)
}
