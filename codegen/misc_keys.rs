...
fn main() {
    ...
    let cm = frozen_collections::maps::HashMap::new(v.clone(), 128).unwrap();
...
#[inline(never)]
fn call_frozen_map(map: &FzHashMap<MyKey, i32>, key: &MyKey) -> bool {
    map.contains_key(key)
}

#[inline(never)]
fn call_hash_map(
    map: &frozen_collections::maps::HashMap<MyKey, i32, SmallCollection>,
    key: &MyKey,
) -> bool {
    map.contains_key(key)
}
