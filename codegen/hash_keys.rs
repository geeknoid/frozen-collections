...
#[inline(never)]
fn call_hash_map_with_bridge_hasher(
    map: &maps::HashMap<MyKey, i32, SmallCollection>,
    key: &MyKey,
) -> bool {
    map.contains_key(key)
}
...
#[inline(never)]
fn call_std_hash_map(map: &HashbrownMap<MyKey, i32, ahash::RandomState>, key: &MyKey) -> bool {
    map.contains_key(key)
}
