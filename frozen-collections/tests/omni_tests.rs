...
macro_rules! test_all {
    ( $( $input:expr ),* ; $( $other:literal ),*) => {
        ...
        let mut m = HashMap::<_, _>::new(map_input.clone(), BridgeHasher::default());
        test_map(&m, &map_reference, &map_other);
        test_map_ops(&m, &map_reference);
        test_map_iter(&m, &map_reference);
        test_map_iter_mut(&mut m, &map_reference);
...
fn test_set_empties() {
    ...
    test_set_empty(&HashSet::<i32>::new(HashMap::new(
        vec![],
    ...
    test_set_empty(&FacadeStringSet::<ahash::RandomState>::default());
...
fn test_map_empties() {
    ...
    test_map_empty(&HashMap::<i32, i32>::new(vec![], BridgeHasher::default()));
    ...
    test_map_empty(&FacadeStringMap::<i32, ahash::RandomState>::default());
    test_map_empty(&FacadeStringMap::<i32, ahash::RandomState>::new(
        vec![],
        ahash::RandomState::default(),
    ));
