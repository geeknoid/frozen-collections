...
pub use frozen_collections_core::traits::{Len, Map, MapIterator, Scalar, Set, SetIterator};

#[doc(hidden)]
pub use frozen_collections_core::traits::{
    CollectionMagnitude, Hasher, LargeCollection, MediumCollection, SmallCollection,
};
...
///     assert_eq!(MY_MAP_0, MY_MAP_1);
///     assert_eq!(MY_MAP_0, my_map_2);
///     assert_eq!(MY_MAP_0, my_map_3);
///     assert_eq!(MY_MAP_0, my_map_4);
///     assert_eq!(MY_MAP_0, my_map_5);
///     assert_eq!(MY_MAP_0, my_map_6);
///
///     assert_eq!(
///         Some(&1),
///         MY_MAP_0.get(&Key {
...
///     assert_eq!(MY_SET_0, MY_SET_1);
///     assert_eq!(MY_SET_0, my_set_2);
///     assert_eq!(MY_SET_0, my_set_3);
///     assert_eq!(MY_SET_0, my_set_4);
///     assert_eq!(MY_SET_0, my_set_5);
///     assert_eq!(MY_SET_0, my_set_6);
///
///     assert!(
...
/// //
/// // This declare a global static map. This results in a static variable called MY_INT_MAP of type MyIntMapType.
...
/// //
/// // This declare a global static set. This results in a static variable called MY_INT_SET of type MyIntSetType.
