...
fn emit_dense_scalar_benchmark() {
    ...
    emit_scalar_suite(&mut file, 3, dense_producer);
    emit_scalar_suite(&mut file, 10, dense_producer);
    emit_scalar_suite(&mut file, 256, dense_producer);
    emit_scalar_suite(&mut file, 1000, dense_producer);
...
fn emit_sparse_scalar_benchmark() {
    ...
    emit_scalar_suite(&mut file, 3, sparse_producer);
    emit_scalar_suite(&mut file, 10, sparse_producer);
    emit_scalar_suite(&mut file, 256, sparse_producer);
    emit_scalar_suite(&mut file, 1000, sparse_producer);
...
fn emit_random_scalar_benchmark() {
    ...
    emit_scalar_suite(&mut file, 3, random_producer);
    emit_scalar_suite(&mut file, 10, random_producer);
    emit_scalar_suite(&mut file, 256, random_producer);
    emit_scalar_suite(&mut file, 1000, random_producer);
...
fn emit_prefixed_string_benchmark() {
    ...
    emit_string_suite(&mut file, 3, prefixed_producer);
    emit_string_suite(&mut file, 10, prefixed_producer);
    emit_string_suite(&mut file, 256, prefixed_producer);
    emit_string_suite(&mut file, 1000, prefixed_producer);
...
fn emit_random_string_benchmark() {
    ...
    emit_string_suite(&mut file, 3, random_producer);
    emit_string_suite(&mut file, 10, random_producer);
    emit_string_suite(&mut file, 256, random_producer);
    emit_string_suite(&mut file, 1000, random_producer);
...
fn emit_hashed_benchmark() {
    ...
    emit_hashed_suite(&mut file, 3, hashed_producer);
    emit_hashed_suite(&mut file, 10, hashed_producer);
    emit_hashed_suite(&mut file, 256, hashed_producer);
    emit_hashed_suite(&mut file, 1000, hashed_producer);
...
fn emit_ordered_benchmark() {
    ...
    emit_ordered_suite(&mut file, 3, ordered_producer);
    emit_ordered_suite(&mut file, 10, ordered_producer);
    emit_ordered_suite(&mut file, 256, ordered_producer);
    emit_ordered_suite(&mut file, 1000, ordered_producer);
