...
use crate::maps::decl_macros::{
    ...
    index_mut_fn, into_iter_fn_for_slice, into_iter_mut_ref_fn, into_iter_ref_fn,
...
use crate::utils::binary_search_by_key;
...
impl<Q, K, V, const SZ: usize> IndexMut<&Q> for InlineBinarySearchMap<K, V, SZ>
where
    K: Borrow<Q>,
    Q: ?Sized + Ord,
{
