...
use crate::inline_maps::inline_hash_table::InlineHashTable;
...
impl<K, V, CM, const SZ: usize, const NHS: usize, H> InlineHashMap<K, V, CM, SZ, NHS, H> {
    pub const fn new(table: InlineHashTable<(K, V), CM, SZ, NHS>, bh: H) -> Self {
...
impl<Q, K, V, CM, const SZ: usize, const NHS: usize, H> IndexMut<&Q>
    for InlineHashMap<K, V, CM, SZ, NHS, H>
where
    K: Borrow<Q>,
    Q: ?Sized + Eq,
