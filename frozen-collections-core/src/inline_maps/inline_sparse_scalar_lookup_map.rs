use crate::maps::decl_macros::{
    ...
    into_iter_mut_ref_fn, into_iter_ref_fn, map_iteration_funcs, partial_eq_fn, sparse_scalar_lookup_query_funcs,
};
use crate::maps::{IntoIter, IntoKeys, IntoValues, Iter, IterMut, Keys, Values, ValuesMut};
use crate::traits::{CollectionMagnitude, Len, Map, MapIteration, MapQuery, Scalar, SmallCollection};
use alloc::vec::Vec;
...
impl<K, V, const SZ: usize, const LTSZ: usize, CM> Map<K, V, K> for InlineSparseScalarLookupMap<K, V, SZ, LTSZ, CM>
where
    CM: CollectionMagnitude,
    K: Scalar,
{
...
impl<K, V, const SZ: usize, const LTSZ: usize, CM> MapQuery<K, V, K> for InlineSparseScalarLookupMap<K, V, SZ, LTSZ, CM>
where
    CM: CollectionMagnitude,
    K: Scalar,
{
...
impl<Q, V, const SZ: usize, const LTSZ: usize, CM> Index<&Q> for InlineSparseScalarLookupMap<Q, V, SZ, LTSZ, CM>
where
    Q: Scalar,
    CM: CollectionMagnitude,
{
