use crate::maps::decl_macros::{
    ...
    into_iterator_trait_mut_ref_funcs, into_iterator_trait_ref_funcs, len_trait_funcs, map_iteration_trait_funcs, map_query_trait_funcs,
    map_trait_funcs, partial_eq_trait_funcs, sparse_scalar_lookup_primary_funcs,
};
...
impl<K, V, Q, const SZ: usize, const LTSZ: usize, CM> MapQuery<K, V, Q> for InlineSparseScalarLookupMap<K, V, SZ, LTSZ, CM>
where
    CM: CollectionMagnitude,
    Q: Comparable<K> + Scalar,
{
