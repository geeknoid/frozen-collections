use crate::maps::decl_macros::{
    ...
    into_iterator_trait_funcs, into_iterator_trait_mut_ref_funcs, into_iterator_trait_ref_funcs, len_trait_funcs,
    map_iteration_trait_funcs, map_query_trait_funcs, map_trait_funcs, partial_eq_trait_funcs,
};
...
impl<K, V, Q, const SZ: usize> Map<K, V, Q> for InlineDenseScalarLookupMap<K, V, SZ>
where
...
impl<K, V, Q, const SZ: usize> MapQuery<K, V, Q> for InlineDenseScalarLookupMap<K, V, SZ>
where
    Q: Comparable<K> + Scalar,
{
