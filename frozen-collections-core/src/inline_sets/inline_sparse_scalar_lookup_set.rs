...
use crate::sets::decl_macros::{
    ...
    into_iterator_trait_funcs, partial_eq_trait_funcs, set_iteration_trait_funcs, set_query_trait_funcs,
    sparse_scalar_lookup_primary_funcs, sub_trait_funcs,
};
use crate::sets::{IntoIter, Iter};
use crate::traits::{CollectionMagnitude, Len, Scalar, Set, SetIteration, SetOps, SetQuery, SmallCollection};
use core::fmt::Debug;
use core::hash::Hash;
...
impl<T, Q, const SZ: usize, const LTSZ: usize, CM> SetQuery<T, Q> for InlineSparseScalarLookupSet<T, SZ, LTSZ, CM>
where
    CM: CollectionMagnitude,
    Q: Comparable<T> + Scalar,
{
