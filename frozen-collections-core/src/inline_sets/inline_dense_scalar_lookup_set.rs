...
use crate::sets::decl_macros::{
    ...
    into_iterator_ref_trait_funcs, into_iterator_trait_funcs, partial_eq_trait_funcs, set_iteration_trait_funcs, set_query_trait_funcs,
    sub_trait_funcs,
};
use crate::sets::{IntoIter, Iter};
use crate::traits::{Len, Scalar, Set, SetIteration, SetOps, SetQuery};
...
impl<T, Q, const SZ: usize> SetQuery<T, Q> for InlineDenseScalarLookupSet<T, SZ>
where
