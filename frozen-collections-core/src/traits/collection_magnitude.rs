...
/// A small collection that can hold up to 255 elements.
...
/// A medium collection that can hold up to 65,535 elements.
...
/// A large collection that can hold up to [`usize::MAX`] elements.
