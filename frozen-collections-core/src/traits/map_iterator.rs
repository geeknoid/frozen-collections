...
pub trait MapIterator<K, V>: IntoIterator<Item = (K, V)> {
...
#[cfg(feature = "std")]
impl<K, V, BH> MapIterator<K, V> for std::collections::HashMap<K, V, BH>
where
    BH: BuildHasher,
{
...
#[cfg(feature = "std")]
impl<K, V> MapIterator<K, V> for std::collections::BTreeMap<K, V> {
...
impl<K, V, BH> MapIterator<K, V> for hashbrown::HashMap<K, V, BH>
where
    BH: BuildHasher,
{
    type Iterator<'a> = hashbrown::hash_map::Iter<'a, K, V>
    where
        K: 'a,
        V: 'a,
        BH: 'a;

    type KeyIterator<'a> = hashbrown::hash_map::Keys<'a, K, V>
    where
        K: 'a,
        V: 'a,
        BH: 'a;

    type ValueIterator<'a> = hashbrown::hash_map::Values<'a, K, V>
    where
        K: 'a,
        V: 'a,
        BH: 'a;
    ...
    type MutIterator<'a> = hashbrown::hash_map::IterMut<'a, K, V>
    where
        K: 'a,
        V: 'a,
        BH: 'a;

    type ValueMutIterator<'a> = hashbrown::hash_map::ValuesMut<'a, K, V>
    where
        K: 'a,
        V: 'a,
        BH: 'a;
